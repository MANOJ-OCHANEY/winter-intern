...
<form action=" {{ url('/staff/addpaperpublications') }} " method='post'> 
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group field_wrapper2">
                ...
                <input type="text" name="coauthor_names[]" class="form-control" placeholder="Co-author Name"/>
                {{-- <div></div> --}}
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="issn_isbn" class='form-control' placeholder="ISSN/ISBN Number" required>
            </div>             
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group">
                <label>Date of conference/publication:</label>
